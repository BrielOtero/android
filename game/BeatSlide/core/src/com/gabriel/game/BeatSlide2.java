 ...
 * @author mgsx
 */
public class BeatSlide2 extends ApplicationAdapter {
    ...
    public void create() {
        ...
        Texture diffuseTexture = new Texture(Gdx.files.classpath("red_bricks_04_diff_1k.jpg"), true);
        Texture normalTexture = new Texture(Gdx.files.classpath("red_bricks_04_nor_gl_1k.jpg"), true);
        Texture mrTexture = new Texture(Gdx.files.classpath("red_bricks_04_rough_1k.jpg"), true);
