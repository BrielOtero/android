...
public class MainActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        d.putExtra("pelis", rellenaPeliculas());
        peliculas=d.getPelis("pelis");
        RecyclerView rv = (RecyclerView) findViewById(R.id.myRV);
        ...
        View.OnClickListener listener = new View.OnClickListener() {
            ...
            public void onClick(View view) {
                seleccionado = adap.getSelectedPos();
                if (seleccionado > -1){
                    TextView tvw = (TextView) findViewById(R.id.textView);
                    tvw.setText(peliculas.get(seleccionado).getTitulo());
                }
            }
        };
        adap.setOnClickListener(listener);
    ...
    public boolean onOptionsItemSelected(@NonNull MenuItem item) {
        switch (item.getItemId()) {
            case R.id.addfilm:
                ...
                return true;
            case R.id.favs:
//                Intent fulllist = new Intent(this, FullInfo.class);
//                startActivity(fulllist);
                Intent listfav = new Intent(this, Favs.class);
                startActivity(listfav);
                return true;
            case R.id.fullList:
                Intent listv = new Intent(this, ListActivity.class);
                startActivity(listv);
