...
import com.gabriel.game.RunnerGame;
import com.gabriel.game.utils.AnimationController;
/**
 * 
 * @author Jake
 *
...
public class Player extends DynamicCharacter {
	...
	public void draw(SpriteBatch batch) {
		...
		if (jumping) {
			setCurrentFrame((TextureRegion) getAnimations().getAnimation(1).getKeyFrame(getStateTime(), false));
			...
			setCurrentFrame((TextureRegion) getAnimations().getAnimation(0).getKeyFrame(getStateTime(), true));
		}
