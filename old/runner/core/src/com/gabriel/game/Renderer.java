...
import com.gabriel.game.simulation.Ship;
...
public class Renderer {
    ...
    public Renderer () {
        try {
            ...
            backgroundTexture = new Texture(Gdx.files.internal("data/planet.jpg"), Pixmap.Format.RGB565, true);
            backgroundTexture.setFilter(TextureFilter.MipMap, Texture.TextureFilter.Linear);
